...
#define PIN                  10  // Data output pin on the arduino
#define BUTTON_PIN           -1  // Data input pin for the button, -1 to disable
#define PIR_PIN             10  // Data input pin for the pir, -1 to disable
#define PIXEL_COUNT         12  // Number of neo-pixels being controlled
...
#define MAX_FADE_ALPHA     100  // Maximum brightness to use during fade in/out
#define MIN_PULSE_ALPHA     30  // Minimum brightness to use during pulse
#define MAX_PULSE_ALPHA    100  // Maximum brightness to use during pulse
